...
#resCon_a002 {
 float:left;width:143px;height: 235px;background:white;margin-left:6px;margin-top: -19px;padding: 25px;text-align:center;border-radius:5px;cursor:pointer;
}
#resCon_a001:hover {
    background:#f1f1f1;
}
#resCon_a002:hover {
    background:#f1f1f1;
                ...
                <div class="card-body" style="padding-left: 4px;padding-right: 0px;height:258px">
                    <div id="resCon_a002" style="background:white;width:97%">
                        <div style="text-align:center;">
                            <h5 style="margin-top:107px">No Profiles Found </h5>
                        </div>
                    </div>
                   </div> 
                </div>
              ...
              <div class="card"  style="background:#dee9ea;">
                <div class="card-body" style="padding:10px !important;">
                    <div class="col-sm-12" id="resCon_a001" style="background:white;height: 443px;">
                        <div style="text-align:center;">
                            <h5 style="margin-top: 197px;">No Profiles Found </h5>
                        </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-5 grid-margin" style="max-width: 35.667%;">
              <div style="width:156px;background:#dee9ea;padding:10px;padding-bottom:0px;padding-left:12px;padding-top:7px">Recent Invitation</div>
              <div class="card"  style="background:#dee9ea;">
                <div class="card-body" style="padding:10px !important;">
                    <div class="col-sm-12" id="resCon_a001" style="background:white;height: 443px;">
                        <div style="text-align:center;">
    ...
    <div class="modal-dialog" style="width:367px">
        <div class="modal-content">
            <div class="modal-body">
                    ...
                    <?php echo $_Member['WelcomeMessage'] ?>
                    <input type="submit" class="btn btn-primary" name="welcomebutton" value="Continue"/>
                    </div>
                    </form>
            </div>
