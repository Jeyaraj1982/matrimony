    ...
    <div class="card">
        ...
        <div class="container"  id="sp"> 
            ...
            <div class="form-group row">
             ...
             <div class="col-sm-6" align="left"><?php $Castes = $mysql->select("select * from _tbl_master_codemaster Where HardCode='CASTNAMES'");?>
            ...
            <b style="font-size:15px">Life Style &amp; Appearances</b><br><br><br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6" align="left"><?php $Diets = $mysql->select("select * from _tbl_master_codemaster Where HardCode='DIETS'");?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6" align="left"><?php $Smokings = $mysql->select("select * from _tbl_master_codemaster Where HardCode='SMOKINGHABITS'");?>
                    <select class="form-control" name="Smoke" id="Smoke">
                        <option value="0">Choose Smoking Habit</option>
                        <?php foreach($Smokings as $S) {?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6" align="left"><?php $Drinks = $mysql->select("select * from _tbl_master_codemaster Where HardCode='DRINKINGHABITS'");?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6" align="left"><?php $Complexions = $mysql->select("select * from _tbl_master_codemaster Where HardCode='COMPLEXIONS'");?>
