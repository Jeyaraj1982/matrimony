<?php
    if (isset($_POST['BtnSavePlan'])) {
        ...
        $ErrorCount =0;
        $duplicate = $mysql->select("select * from  _tbl_franchisees_plans where PlanName='".trim($_POST['PlanName'])."'");
        if (sizeof($duplicate)>0) {
             $ErrPlanName="Plan Name Already Exists";    
             $ErrorCount++;
        }
        $duplicate = $mysql->select("select * from  _tbl_franchisees_plans where PlanCode='".trim($_POST['PlanCode'])."'");
        if (sizeof($duplicate)>0) {
             $ErrPlanCode="Plan Code Already Exists";    
             $ErrorCount++;
        }
        
        if ($ErrorCount==0) {
        $PlansID = $mysql->insert("_tbl_franchisees_plans",array("PlanCode"                                 => $_POST['PlanCode'],
                 ...
                 $mysql->insert("_tbl_franchisee_choosenplan",array("PlanID"       => $_POST['PlanCode'],
                                                                    "FranchiseeID" =>$FranchiseeID,
                                                                    "PlanString"   => $_POST['PlanName'],
                                                                    "Created"      => date("Y-m-d H:i:s"),
                                                                    "Expired"      => $_POST['Duration']));
                             ...
                             <h4 class="card-title">Create Plan</h4>
                                 <form class="forms-sample">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" maxlength="7" id="PlanCode" name="PlanCode" value="<?php echo isset($_POST['PlanCode']) ? $_POST['PlanCode'] : Plan::GetNextPlanNumber();?>" placeholder="Plan Code">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                <input type="text" class="form-control" id="ProfileCommissionWithPercentage" name="ProfileCommissionWithPercentage" value="<?php echo (isset($_POST['ProfileCommissionWithPercentage']) ? $_POST['ProfileCommissionWithPercentage'] : "");?>" placeholder="Commission">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                <div class="input-group-addon">Rs</div>
                                                <input type="text" class="form-control" id="ProfileCommissionWithRupees" name="ProfileCommissionWithRupees" value="<?php echo (isset($_POST['ProfileCommissionWithRupees']) ? $_POST['ProfileCommissionWithRupees'] : "");?>" placeholder="Amount">
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                <input type="text" class="form-control" id="RefillCommissionWithPercentage" name="RefillCommissionWithPercentage" value="<?php echo (isset($_POST['RefillCommissionWithPercentage']) ? $_POST['RefillCommissionWithPercentage'] : "");?>" placeholder="Commission">
                                                <div class="input-group-addon">%</div>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                <div class="input-group-addon">Rs</div>
                                                <input type="text" class="form-control" id="RefillCommissionWithRupees" name="RefillCommissionWithRupees" value="<?php echo (isset($_POST['RefillCommissionWithRupees']) ? $_POST['RefillCommissionWithRupees'] : "");?>" placeholder="Amount">
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                <input type="text" class="form-control" id="ProfileDownloadCommissionWithPercentage" name="ProfileDownloadCommissionWithPercentage" value="<?php echo (isset($_POST['ProfileDownloadCommissionWithPercentage']) ? $_POST['ProfileDownloadCommissionWithPercentage'] : "");?>" placeholder="Commission">
                                                <div class="input-group-addon">%</div>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                <div class="input-group-addon">Rs</div>
                                                <input type="text" class="form-control" id="ProfileDownloadCommissionWithRupees" name="ProfileDownloadCommissionWithRupees" value="<?php echo (isset($_POST['ProfileDownloadCommissionWithRupees']) ? $_POST['ProfileDownloadCommissionWithRupees'] : "");?>" placeholder="Amount">
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">                         
                                                <input type="text" class="form-control" id="RenewalCommissionWithPercentage" name="RenewalCommissionWithPercentage" value="<?php echo (isset($_POST['RenewalCommissionWithPercentage']) ? $_POST['RenewalCommission'] : "");?>" placeholder="Commission">
                                                <div class="input-group-addon">%</div>
                                                </div>
                                            ...
                                            <div class="col-sm-2" align="center">OR</div>
                                                <div class="col-sm-3">
                                                    <div class="input-group">
                                                    <div class="input-group-addon">Rs</div>
                                                    <input type="text" class="form-control" id="RenewalCommissionWithRupees" name="RenewalCommissionWithRupees" value="<?php echo (isset($_POST['RenewalCommissionWithRupees']) ? $_POST['RenewalCommissionWithRupees'] : "");?>" placeholder="Amount">
                                                    </div>
