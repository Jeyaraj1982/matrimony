         <!--<div class="row purchace-popup">
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Wallet Requests</p>
                      <div class="fluid-container">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Request for Public Profile
                 </h5>
                  <div class="fluid-container">
        ...
        <div class="col-lg-6" style="text-align: right; padding-top:1px;"><a href="#">View</a> </div> 
       </div>    
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Member Chart</h4>
                  <canvas id="barChart" style="height:250px"></canvas>
                </div>
              </div>
            </div>
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Recently Expired</h5>
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-sm-2">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="<?php echo SiteUrl?>images/userimage.jpg" alt="profile image">
