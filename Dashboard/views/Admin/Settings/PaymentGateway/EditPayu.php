...
<?php
                if (isset($_POST['UpdatePayu'])) {
                    ...
                    if ($err==0) {
                        ...
                        $res =$webservice->getData("Admin","EditPayu",$_POST);   
...
<form method="post" id="frmfrPaymentGateway" enctype="multipart/form-data">
    ...
    <input type="hidden" value="<?php echo $Payu['PaymentGatewayVendorCode'];?>" name="PaymentGatewayVendorCode" id="PaymentGatewayVendorCode">
    <h4 class="card-title">Edit Payu</h4>                    
    <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Payu Biz Name<span id="star">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="PayBi2Name" name="PayBi2Name" value="<?php echo isset($_POST['PayBi2Name']) ? $_POST['PayBi2Name'] : $Payu['VenderName'];?>" placeholder="Payu Biz Name">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <?php if(isset($Payu['VendorLogo'])){?>
                            <img src="<?php echo AppUrl;?>uploads/Payu/<?php echo $Payu['VendorLogo'];?>" style="height:200px;width:150px">
                          <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MarchantID" name="MarchantID" value="<?php echo isset($_POST['MarchantID']) ? $_POST['MarchantID'] : $Payu['MarchantID'];?>" placeholder="Marchant ID">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="PayuKey" name="PayuKey" value="<?php echo isset($_POST['PayuKey']) ? $_POST['PayuKey'] : $Payu['Secretky'];?>" placeholder="Key">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="SaltID" name="SaltID" value="<?php echo isset($_POST['SaltID']) ? $_POST['SaltID'] : $Payu['SaltID'];?>" placeholder="Salt ID">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" id="Mode"  name="Mode" >
                                    <option value="Live" <?php echo (isset($_POST[ 'Mode'])) ? (($_POST[ 'Mode']=="Live") ? " selected='selected' " : "") : (($Payu[ 'VendorMode']=="Live") ? " selected='selected' " : "");?>>Live</option>
                                    <option value="Test" <?php echo (isset($_POST[ 'Mode'])) ? (($_POST[ 'Mode']=="Test") ? " selected='selected' " : "") : (($Payu[ 'VendorMode']=="Test") ? " selected='selected' " : "");?>>Test</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="SuccessUrl" name="SuccessUrl" value="<?php echo isset($_POST['SuccessUrl']) ? $_POST['SuccessUrl'] : $Payu['SuccessUrl'];?>" placeholder="Success Url">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="FailureUrl" name="FailureUrl" value="<?php echo isset($_POST['FailureUrl']) ? $_POST['FailureUrl'] : $Payu['FailureUrl'];?>" placeholder="Failure Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="PayuRemarks" name="PayuRemarks" placeholder="Remarks"><?php echo isset($_POST['PayuRemarks']) ? $_POST['PayuRemarks'] : $Payu['Remarks'];?></textarea>
        ...
        <div class="form-group row" >
            <div class="col-sm-12" style="text-align:right">
                ...
                <a href="javascript:void(0)" onclick="ConfirmEditPayu()" class="btn btn-primary mr-2" style="font-family:roboto">Update </a>
                <input type="submit" name="UpdatePayu" id="UpdatePayu" style="display: none;">
            </div>
        </div>
    ...
    if(SubmitPayu()) {
            ...
            var content = '<div class="modal-header">'
                           ...
                           + '<div class="modal-body">'
                                + '<div class="form-group row" style="margin:0px;padding-top:10px;">'
                                    ...
                                    + '<div class="col-sm-8"><br>'
                                        + '<div class="form-group row">'
                                            +'<div class="col-sm-12">Are you sure want to edit payu<br>'
                                            +'</div>'
                                        +'</div>'
                                    + '</div>'
                                + '</div>'
                           ...
                           + '<div class="modal-footer">'
                                ...
                                + '<button type="button" class="btn btn-primary" name="Update" onclick="GetTxnPasswordFrEditPayu()" style="font-family:roboto">Update</button>'
                           + '</div>';
...
function GetTxnPasswordFrEditPayu() {
        var content =  '<div class="modal-header">'
                    ...
                    + '</div>'
                        + '<div class="modal-footer">'
                            + '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>&nbsp;&nbsp;'
                            + '<button type="button" onclick="EditPayu()" class="btn btn-primary" >Continue</button>'
                        + '</div>';
        $('#Publish_body').html(content);            
    }
function EditPayu() {
