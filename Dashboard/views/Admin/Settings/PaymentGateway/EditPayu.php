...
<form method="post" id="frmfrPaymentGateway" enctype="multipart/form-data">
    ...
    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="PayBi2Name" name="PayBi2Name" value="<?php echo isset($_POST['PayBi2Name']) ? $_POST['PayBi2Name'] : $Payu['VenderName'];?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MarchantID" name="MarchantID" value="<?php echo isset($_POST['MarchantID']) ? $_POST['MarchantID'] : $Payu['MarchantID'];?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="PayuKey" name="PayuKey" value="<?php echo isset($_POST['PayuKey']) ? $_POST['PayuKey'] : $Payu['Secretky'];?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="SaltID" name="SaltID" value="<?php echo isset($_POST['SaltID']) ? $_POST['SaltID'] : $Payu['SaltID'];?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" id="Mode"  name="Mode" >
                                    <option value="Live" <?php echo (isset($_POST[ 'Mode'])) ? (($_POST[ 'Mode']=="Live") ? " selected='selected' " : "") : (($Payu[ 'Mode']=="Live") ? " selected='selected' " : "");?>>Live</option>
                                    <option value="Test" <?php echo (isset($_POST[ 'Mode'])) ? (($_POST[ 'Mode']=="Test") ? " selected='selected' " : "") : (($Payu[ 'Mode']=="Test") ? " selected='selected' " : "");?>>Test</option>
                                </select>
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" id="Status"  name="Status" >
                                    <option value="1" <?php echo (isset($_POST[ 'Status'])) ? (($_POST[ 'Status']=="1") ? " selected='selected' " : "") : (($Payu[ 'VendorStatus']=="1") ? " selected='selected' " : "");?>>Active</option>
                                    <option value="0" <?php echo (isset($_POST[ 'Status'])) ? (($_POST[ 'Status']=="0") ? " selected='selected' " : "") : (($Payu[ 'VendorStatus']=="0") ? " selected='selected' " : "");?>>Deactive</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="SuccessUrl" name="SuccessUrl" value="<?php echo isset($_POST['SuccessUrl']) ? $_POST['SuccessUrl'] : $Payu['SuccessUrl'];?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="FailureUrl" name="FailureUrl" value="<?php echo isset($_POST['FailureUrl']) ? $_POST['FailureUrl'] : $Payu['FailureUrl'];?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="PayuRemarks" name="PayuRemarks"><?php echo isset($_POST['PayuRemarks']) ? $_POST['PayuRemarks'] : $Payu['Remarks'];?></textarea>
