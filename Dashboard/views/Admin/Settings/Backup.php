                ...
                <div style="max-width:770px !important;">
                 ...
                 <div style="text-align: center;">
                    <Span>Your previous request still in process</span><br>
                     ...
                     <label class="col-form-label" style="font-weight: normal">Initialized&nbsp;:&nbsp;<?php echo putDateTime($response['data'][0]['BackupOn']);?></label><br>
                    <a href="<?php echo GetUrl("Settings/ListofBackup");?>" class="btn btn-primary" style="padding:7px 20px" >Continue</a>
                 </div>
                 </div>
            </div>
        </div>
