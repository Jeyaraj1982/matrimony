...
//$data  = $response['data']['ImageOnProfilePhoto'];
                if (isset($_POST['BtnSave'])) {
                    ...
                    $target_dir = "uploads/";
                    if (!is_dir('uploads/ImageOnProfilePhoto/')) {
                        mkdir('uploads/ImageOnProfilePhoto/', 0777, true);
                    }
                    $err=0;
                    ...
                    if (isset($_FILES['File']['name']) && strlen(trim($_FILES['File']['name']))>0) {
                        ...
                        if (!(move_uploaded_file($_FILES["File"]["tmp_name"],'uploads/ImageOnProfilePhoto/'. $ImageOnProfilePhoto))) {
                            $err++;
