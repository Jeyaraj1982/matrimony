...
<form method="post" id="frmfrn">
    ...
    <div class="col-sm-12">
        <div class="form-group row">
          <div class="col-sm-2"><a href="javascript:void(0)" onclick="Franchisee.ConfirmEditFranchisee()" class="btn btn-primary" name="BtnSaveCreate">Update Franchisee</a></div>
		  <div class="col-sm-4"><a href="../MangeFranchisees"><small style="font-weight:bold;text-decoration:underline">List of Franchisee</small></a></div>
        </div>
    </div>
    ...
    if(SubmitNewFranchisee()) {
      ...
      var content = ''
                    ...
                    + '<div class="modal-footer">'
                        ...
                        + '<button type="button" class="btn btn-primary" name="Create" class="btn btn-primary" onclick="Franchisee.GetTxnPassword()" style="font-family:roboto">Update Franchisee</button>'
                    + '</div>';
...
GetTxnPassword:function() {
    ...
    var content =     '<div class="modal-header">'
					...
					+ '<div class="modal-footer">'
						+ '<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>&nbsp;&nbsp;'
						+ '<button type="button" onclick="Franchisee.EditFranchisee()" class="btn btn-primary">Update Franchisee</button>'
					+ '</div>';
            $('#Publish_body').html(content);            
},
            ...
            if (obj.status == "success") {
                ...
                var content = '<div  style="height: 300px;">'                                                                              
                                +'<div class="modal-body" style="min-height:175px;max-height:175px;">'
                                    ...
                                    + '<h3 style="text-align:center;">Franchisee Updated</h3>'
