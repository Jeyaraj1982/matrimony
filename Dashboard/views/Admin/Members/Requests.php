    ...
    <div class="card">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9" style="text-align:right;padding-top:5px;color:skyblue;">
                <a href="Requests"><small  style="font-weight:bold;text-decoration:underline">Deactive Request</small></a>&nbsp;|&nbsp;
            ...
            <div class="table-responsive">   
                ...
                <tbody> 
                    <?php $response = $webservice->getData("Admin","GetManageRequests",array("Request"=>"Deactive")); ?>  
                    <?php foreach($response['data'] as $Request) { ?>
                        ...
                        <form method="post" id="frmfrn_<?php echo $Request['ReqID'];?>">      
                            ...
                            <td style="text-align:right">
                                <a href="javascript:void(0)" onclick="Member.GetTxnPasswordViewDactiveRequest('<?php echo $Request['ReqID'];?>')"><span>View</span></a>
                            </td>
                            </tr>
                         </form>
                    <?php } ?>            
