                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-3"><small style="color:#737373;"><?php echo $Member[0]['MemberLogin'];?></small></div>
                          <div class="col-sm-2"><small>Aadhaar No:</small></div>
                          <div class="col-sm-3"><small style="color:#737373;"><?php echo  $Member[0]['AadhaarNumber'];?></small></div>
                      </div>
                      <div class="form-group row">
