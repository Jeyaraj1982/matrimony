                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        <div class="form-group row">
                          ...
                          <label for="ProfileSigninFor" class="col-sm-3 col-form-label"><?php echo $ProfileSigninFor[0]['SoftCode'];?></label>
                        </div>
                        <div class="form-group row">
                          <label for="ReligionName" class="col-sm-3 col-form-label">Religion Name</label>
                          <label for="ReligionName" class="col-sm-3 col-form-label"><?php echo  $ProfileSigninFor[0]['CodeValue'];?></label>
                        </div>
                         <div class="form-group row">
                          <label for="IsActive" class="col-sm-3 col-form-label">Is Active</label>
                          <label for="IsActive" class="col-sm-3 col-form-label"><?php echo  ($ProfileSigninFor[0]['IsActive']) ? "Active" : "DeActive";?></label>
                        </div>
                        <div class="form-group row">
