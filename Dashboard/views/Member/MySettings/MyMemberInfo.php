...
<form method="post" action="">
    <div class="col-sm-9" style="margin-top: -8px;">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2" style="margin-right: -47px;"><small></small> </div>
            <div class="col-sm-3"><small style="color:#737373;"></small></div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">:&nbsp;<small style="color:#737373;"><?php if($Member['IsMobileVerified']==0){ ?><?php echo $Member['CountryCode'];?>-<?php echo $Member['MobileNumber'];?><?php } else {?><?php echo $Member['CountryCode'];?>-<?php echo $Member['MobileNumber'];?><img src="<?php echo SiteUrl?>assets/images/Green-Tick-PNG-Picture.png" width="15%" style="margin-top: -12px;margin-left: 9px;"><?php }?></small></div>
            <div class="col-sm-2" style="margin-right: -47px;"><small>Email ID</small></div>
            <div class="col-sm-5">:&nbsp;<small style="color:#737373;"><?php if($Member['IsEmailVerified']==0){ ?><?php echo  $Member['EmailID'];?><?php } else{ ?><?php echo  $Member['EmailID'];?><img src="<?php echo SiteUrl?>assets/images/Green-Tick-PNG-Picture.png" width="10%" style="margin-top: -11px;margin-left:10px;"><?php }?></small></div>
        </div>
        <div class="form-group row">
