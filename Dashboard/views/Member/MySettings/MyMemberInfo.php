...
<form method="post" action="">
    <div class="col-sm-9" style="margin-top: -8px;">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">:&nbsp;<small style="color:#737373;"><?php if($Member['IsEmailVerified']==0){ ?><?php echo  $Member['EmailID'];?>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="EmailVerification()">Verify</a><?php } else{ ?><?php echo  $Member['EmailID'];?><img src="<?php echo SiteUrl?>assets/images/Green-Tick-PNG-Picture.png" width="10%" style="margin-top: -11px;margin-left:10px;"><?php }?></small></div>
        </div>
        <div class="form-group row">
