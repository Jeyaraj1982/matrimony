<ul class="ft-left-nav fusmyacc_leftnav" style="padding: 0px;list-style: none;">
        ...
        <li class="ft-left-nav-list fusmyacc_leftnavicon2 <?php echo ($page=="MyPrivacyInfo") ? ' linkactive1 ':'';?>"style="padding: 8px 0px 8px 14px;border-bottom:1px solid #eee;">
        ...
        <li class="ft-left-nav-list fusmyacc_leftnavicon2 <?php echo ($page=="KYC") ? ' linkactive1 ':'';?>"style="padding: 8px 0px 8px 14px;border-bottom:1px solid #eee;">
            <a id="myaccount_leftnav_a_6" href="<?php echo GetUrl("MySettings/KYC");?>" class="Notification" style="text-decoration:none"><span>KYC</b></span>
            </a>
        </li>
        ...
        <li class="ft-left-nav-list fusmyacc_leftnavicon2 <?php echo ($page=="Activities") ? ' linkactive1 ':'';?>"style="padding: 8px 0px 8px 14px;border-bottom:1px solid #eee;">
