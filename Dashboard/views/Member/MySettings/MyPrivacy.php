...
<form method="post" action="">
    <div class="col-sm-9" style="margin-top: -8px;">
        ...
        <div class="form-group row" style="margin-bottom:0px">
            ...
            <label for="VerfiedMembers" class="col-sm-11" style="margin-top: 2px;color:#444">Show photo for verified members</label>
        </div>
        <div class="form-group row" style="margin-bottom:0px">
            ...
            <label for="non-VerfiedMembers" class="col-sm-11" style="margin-top: 2px;color:#444">Show photo for non verified members</label>
        </div>
