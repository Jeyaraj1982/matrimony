...
<form method="post" action="">
    <div class="col-sm-9" style="margin-top: -8px;">
        <h4 class="card-title">My Privacy</h4>
        <div class="form-group row">
            ...
            <label for="VerfiedMembers" class="col-sm-11" style="margin-top: 2px;">Show photo for verified members</label>
        </div>
        <div class="form-group row">
            ...
            <label for="non-VerfiedMembers" class="col-sm-11" style="margin-top: 2px;">Show photo for non verified members</label>
        </div>
        <div class="form-group row">
            <div class="col-sm-12"><?php echo $successmessage;?><?php echo $errormessage;?></div>
        </div>
        <div class="form-group row">
            <div class="col-sm-3"><button type="submit" name="savprivacy" id="savprivacy" class="btn btn-primary" style="font-family:roboto">Submit</button></div>
        </div>
    </div>
</form>                
