    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <label class="col-sm-2 col-form-label">Father's Alive</label>
             <label class="col-sm-3 col-form-label" style="color:#737373;">:&nbsp;&nbsp;<?php if($ProfileInfo['FathersAlive']=="0"){ echo "Yes";}else { echo "Passed away" ;}?></label></label> 
        </div>
        ...
        <div class="form-group row">
             ...
             <label class="col-sm-3 col-form-label" style="color:#737373;">:&nbsp;&nbsp;<?php if($ProfileInfo['MothersAlive']=="0"){ echo "Yes";}else { echo "Passed away" ;}?></label></label>
         </div>
