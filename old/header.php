...
<script>
    ...
    <div class="col-sm-12">
           ...
           <div class="col-sm-2" style="margin-right: -42px;margin-left: -10px;">
                <input type="text" id="UserName" name="UserName" placeholder="Email ID" value="<?php echo isset($_POST['UserName']) ? $_POST['UserName'] : '';?>" style="font-size: 15px;line-height: 30px;width: 88%;padding-left:19px;padding-right: 20px;border: 1px solid #ccc;border-radius: 3px;">
