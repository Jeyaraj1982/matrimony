...
$(document).ready(function () {
   ...
   $("#LoginPassword").blur(function () {
       ...
       IsPassword("LoginPassword","ErrLoginPassword","Please Enter More than 6 characters");  
...
function submitregform() {
                        ...
                        IsAlphaNumeric("Name","ErrName","Please enter alpha numeric characters only");
                        }
...
?>
    ...
    <div style="background:#F2F2F2;height:1297px;margin-top:-5px;padding-top:30px">
          ...
          <?php  $response = $webservice->getData("Member","GetLandingPageProfiles",array("show"=>"male"));
     ...
     <div class="col-sm-12" style="margin-left: 17px;">
           <?php  $response = $webservice->getData("Member","GetLandingPageProfiles",array("show"=>"female"));
                   foreach($response['data'] as $p){ 
                       $Profile=$p['ProfileInfo']
            ?>
            <div class="col-sm-3" style="background: white;height: 375px;margin-right: 30px;margin-bottom: 35px;padding:15px;width:270px">
