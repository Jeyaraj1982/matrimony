<script src="../../website/assets/js/jquery-1.7.2.js"></script>
...
<script src="../../website/assets/js/tiny_mce/tiny_mce.js"></script>
    ...
    <form action="" method="post" style="height: 20px;"  enctype="multipart/form-data">
            ...
            <tr>
                <td colspan="2">
                    <table>
                        ...
                        <tr>
                            <td><textarea cols="32" rows="5" name="keywords" value="<?php echo $pageContent[0]['keywords'];?>"></textarea></td>
                            <td><textarea cols="32" rows="5" name="desc" value="<?php echo $pageContent[0]['description'];?>"></textarea></td>
                        </tr>
                    </table>
                </td>
            </tr>
      ...
      <div class="titleBar">View Page</div>
       <table  style="margin:10px;width:100%;font-size:12px;font-family:'Trebuchet MS';color:#333" cellpadding="3" cellspacing="0" align="center">
        ...
        <tr>
            <td>Keywords</td> 
            <td><?php echo $pageContent[0]['keywords'];?></td>
        </tr>
        <tr>
            <td>Description</td> 
            <td><?php echo $pageContent[0]['description'];?></td>
        </tr>
        <tr>
            <td>Is Published</td>  
